...
class CloudStorageApplicationTests {
	...
	public void testUserSignupLoginLogout() throws InterruptedException {
		// signup the user
		doMockSignUp("NEO","TEST","NEO","12345678");

		// login the user
		doLogIn("NEO", "12345678");
	...
	public void createNote() throws InterruptedException {
		...
		inputDescription.sendKeys("testing input a note ...");
		...
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("user-table")));
	...
	public void editNote() throws InterruptedException {
		...
		inputDescription.sendKeys("edited description ... to some thing ");
...
//		Thread.sleep(3000);
	...
	public void deleteNote() throws InterruptedException {
		...
		WebElement notesTable = driver.findElement(By.id("user-table"));
	...
	public void createCredential() throws InterruptedException {
		...
		WebDriverWait webDriverWait = new WebDriverWait(driver, 2);
		String inputCredentialPassword = "123456784";
		...
		WebElement credentialsTable = driver.findElement(By.id("credential-table"));
		...
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("credential-table")));
	...
	public void editCredentials() throws InterruptedException {
		...
		inputURL.click();
		inputURL.clear();
		inputURL.sendKeys("https://github.com/NEODandachi");
		...
		// check changes
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("credential-table")));
		Assertions.assertTrue(driver.findElement(By.id("table-cred-url")).getText().contains("https://github.com/NEODandachi"));
	...
	public void deleteCredentials() throws InterruptedException {
		...
		WebElement credentialTable = driver.findElement(By.id("credential-table"));
	...
	private void doMockSignUp(String firstName, String lastName, String userName, String password){
		...
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("input-first-name")));
		WebElement inputFirstName = driver.findElement(By.id("input-first-name"));
		inputFirstName.click();
		inputFirstName.sendKeys(firstName);

		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("input-last-name")));
		WebElement inputLastName = driver.findElement(By.id("input-last-name"));
		inputLastName.click();
		inputLastName.sendKeys(lastName);

		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("input-user-name")));
		WebElement inputUsername = driver.findElement(By.id("input-user-name"));
		inputUsername.click();
		...
		// Attempt to sign up.
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("button-sign-up")));
		WebElement buttonSignUp = driver.findElement(By.id("button-sign-up"));
		buttonSignUp.click();
...
//		Assertions.assertTrue(driver.findElement(By.id("success-msg")).getText().contains("You successfully signed up!"));
	...
	private void doLogIn(String userName, String password)
	{
		...
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("input-user-name")));
		WebElement loginUserName = driver.findElement(By.id("input-user-name"));
		loginUserName.click();
	...
	public void testRedirection() {
		...
		doMockSignUp("Redirection","TEST","NEO","12345678");
	...
	public void testBadUrl() {
		...
		driver.get("http://localhost:" + this.port + "/some-random-page-not-found");
	...
	public void testLargeUpload() {
		// Create a test account
		doMockSignUp("Large File","TEST","NEO","12345678");
		doLogIn("NEO", "12345678");
		...
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("upload-file-button")));
		WebElement fileSelectButton = driver.findElement(By.id("upload-file-button"));
		fileSelectButton.sendKeys(new File(fileName).getAbsolutePath());

		WebElement uploadButton = driver.findElement(By.id("upload-file-button"));
		uploadButton.click();
		try {
...
//	@Test
//	public void testLegitFileUpload(){
//		// Create a test account
//		doMockSignUp("Test ","file upload ","NEO","12345678");
//		doLogIn("NEO", "12345678");
//
//		// Try to upload an arbitrary large file
//		WebDriverWait webDriverWait = new WebDriverWait(driver, 2);
...
//
//		// Check if the note appears
//		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("files-table")));
//		Assertions.assertTrue(driver.findElement(By.className("file-name")).getText().contains("testText.txt"));
////		Thread.sleep(3000);
//	}
